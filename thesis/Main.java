...
public class Main {
	...
	public static void main(String[] args) {
		...
		winners.add(election1.makeElection(true));
		winners.add(election2.makeElection(true));
		winners.add(election3.makeElection(true));
		winners.add(election4.makeElection(true));
		System.out.println();
